...
<title>History Curriculum_Junior 3</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=junior3>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("junior3");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "History_Curriculum_Junior3.xlsx");
}
</script>
