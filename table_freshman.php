...
<title>Curriculum_Freshman</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=freshman>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("freshman");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "Curriculum_Freshman.xlsx");
}
</script>
