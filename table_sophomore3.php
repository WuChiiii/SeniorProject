...
<title>History Curriculum_Sophomore 3</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=sophomore3>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("sophomore3");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "History_Curriculum_Sophomore3.xlsx");
}
</script>
