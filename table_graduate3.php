...
<title>History Curriculum_Graduate 3</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=graduate3>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("graduate3");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "History_Curriculum_Graduate3.xlsx");
}
</script>
