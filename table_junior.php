...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=junior>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("junior");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "Curriculum_Junior.xlsx");
}
</script>
