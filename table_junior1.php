...
<title>History Curriculum_Junior 1</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=junior1>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("junior1");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "History_Curriculum_Junior1.xlsx");
}
</script>
