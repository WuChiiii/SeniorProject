...
<title>Curriculum_Sophomore</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=sophomore>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("sophomore");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "Curriculum_Sophomore.xlsx");
}
</script>
