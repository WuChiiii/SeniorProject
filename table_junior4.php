...
<title>History Curriculum_Junior 4</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=junior4>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("junior4");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "History_Curriculum_Junior4.xlsx");
}
</script>
