...
<title>History Curriculum_Freshman 4</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=freshman4>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("freshman4");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "History_Curriculum_Freshman4.xlsx");
}
</script>
