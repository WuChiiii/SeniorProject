...
<title>History Curriculum_Freshman 3</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=freshman3>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("freshman3");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "History_Curriculum_Freshman3.xlsx");
}
</script>
