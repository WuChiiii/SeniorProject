                ...
                <?php include ('connect.php');
                            ...
                            <form  method="post" enctype="multipart/form-data" action="edit_subject_database.php"> <hr>			
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                    <input type="text" name="classType" pattern="[01]*" class = "form-control" value="<?php if( $cur['classType'] == '選(elective)' ) echo 0 ; else if( $cur['classType'] == '必(required)' ) echo 1 ; else echo $cur['classType'] ;?>" required>
                                    </div>              
                                </div>
