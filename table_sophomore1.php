...
<title>History Curriculum_Sophomore 1</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=sophomore1>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("sophomore1");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "History_Curriculum_Sophomore1.xlsx");
}
</script>
