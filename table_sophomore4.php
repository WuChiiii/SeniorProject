...
<?php
	include "connect.php" ;
	$sql = "SELECT * FROM pre4_csie";
	$normal = $conn->query($sql);
	$sql1 = "SELECT * FROM pre4_international";
...
<title>History Curriculum_Sophomore 4</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=sophomore4>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("sophomore4");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "History_Curriculum_Sophomore4.xlsx");
}
</script>
