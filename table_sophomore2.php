...
<title>History Curriculum_Sophomore 2</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=sophomore2>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("sophomore2");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "History_Curriculum_Sophomore2.xlsx");
}
</script>
