            ...
            <div class="modal-body">
                ...
                <form  method="post" enctype="multipart/form-data" action="admin_add_course_db.php"> <hr>			
					...
					<div class="control-group">
                     ...
                     <div class="control-group">
                        <label class="control-label" for="inputPassword">Class Time<br>(星期幾-第幾堂課/星期幾-第幾堂課)e.g.1-4/1-5/1-6為星期一第四節至第六節(9a.m.-12p.m.)</label>
                        <input type="text" name="time" class = "form-control" pattern="([1-5]-[1-9]|[1-5]-1[0-6])(\/([1-5]-[1-9]|[1-5]-1[0-6]))*" placeholder="e.g.2-9/2-10">       
                    </div>
                    
                    <div class="control-group">
                        <label class="control-label" for="inputPassword">Classroom Type*<br>General Classroom:0Computer Classroom:1;;Specific Classroom:2</label>
                        <div class="controls">
                        <input type="text" name="Classroom_Type" pattern="[012]" class = "form-control" placeholder="0:General Classroom; Computer Classroom:1; 2:Specific Classroom" required>
                        </div>              
                    </div>
