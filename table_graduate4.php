...
<title>History Curriculum_Graduate 4</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=graduate4>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("graduate4");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "History_Curriculum_Graduate4.xlsx");
}
</script>
