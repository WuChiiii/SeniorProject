...
<title>Curriculum_Graduate</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=graduate>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("graduate");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "Curriculum_Graduate.xlsx");
}
</script>
