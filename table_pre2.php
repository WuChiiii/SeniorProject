...
<title>History curriculum 2</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=pre2_Table>
		<thead>
			<tr>
				<thead>
					<tr>
			...
			<td width="30" align="center">
				...
				<?php
					if($normal1["1-1"] == -1)//當下沒課
						...
						$classroomid=$idrow["pre2_classroom_id"];$professorid=$idrow["professor_id"]; 
						$name=$row["courseName"];
...
function exportToExcel() {
  var table = document.getElementById("pre2_Table");
