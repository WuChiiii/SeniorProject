...
<title>History Curriculum_Freshman 1</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=freshman1>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("freshman1");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "History_Curriculum_Freshman1.xlsx");
}
</script>
