...
<title>History Curriculum_Graduate 1</title>
...
<center>
	...
	<table border="1" style="border-collapse:collapse;" id=graduate1>
		<thead>
			<tr>
				<thead>
					<tr>
...
function exportToExcel() {
  var table = document.getElementById("graduate1");
  var wb = XLSX.utils.table_to_book(table, {sheet:"Sheet1"});
  XLSX.writeFile(wb, "History_Curriculum_Graduate1.xlsx");
}
</script>
